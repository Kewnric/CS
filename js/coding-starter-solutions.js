...
const CS_SOLUTIONS = {
  'mem-menu':
    "#include <stdio.h>\n#include <stdlib.h>\n\nint main(void) {\n    int *nums = NULL;\n    int count = 0, cap = 0, choice, i, total;\n\n    do {\n        printf(\"=== Growing List ===\\n\");\n        printf(\"1. Add a number\\n\");\n        printf(\"2. List\\n\");\n        printf(\"3. Total\\n\");\n        printf(\"0. Exit\\n\");\n        printf(\"Choice: \");\n        scanf(\"%d\", &choice);\n\n        switch (choice) {\n            case 1:\n                if (count == cap) {\n                    cap = (cap == 0) ? 2 : cap * 2;\n                    nums = realloc(nums, cap * sizeof(int));\n                    if (nums == NULL) {\n                        printf(\"Out of memory\\n\");\n                        return 1;\n                    }\n                    printf(\"Room for %d now\\n\", cap);\n                }\n                printf(\"Enter a number: \");\n                scanf(\"%d\", &nums[count]);\n                count = count + 1;\n                printf(\"Holding %d of %d\\n\", count, cap);\n                break;\n            case 2:\n                if (count == 0) {\n                    printf(\"Empty\\n\");\n                } else {\n                    for (i = 0; i < count; i++) {\n                        printf(\"%d. %d\\n\", i + 1, nums[i]);\n                    }\n                }\n                break;\n            case 3:\n                total = 0;\n                for (i = 0; i < count; i++) {\n                    total = total + nums[i];\n                }\n                printf(\"Total %d\\n\", total);\n                break;\n            case 0:\n                break;\n            default:\n                printf(\"No such choice\\n\");\n                break;\n        }\n    } while (choice != 0);\n\n    free(nums);\n    printf(\"Bye\\n\");\n    return 0;\n}\n",
  /* ── Added variations ────────────────────────────────────
     Every one of these was compiled and run before it was written down;
     the tests beside them hold what the program actually printed, not what
     it was hoped to print. See tools/verify-pack.js. */
  'struct-func':
    "#include <stdio.h>\n\ntypedef struct {\n    char name[32];\n    int level;\n} Pokemon;\n\nvoid levelUpCopy(Pokemon p) {\n    p.level = p.level + 1;\n}\n\nvoid levelUpReal(Pokemon *p) {\n    p->level = p->level + 1;\n}\n\nint main(void) {\n    Pokemon p;\n\n    printf(\"Enter name and level: \");\n    scanf(\"%31s %d\", p.name, &p.level);\n\n    levelUpCopy(p);\n    printf(\"After the copy: %s %d\\n\", p.name, p.level);\n\n    levelUpReal(&p);\n    printf(\"After the pointer: %s %d\\n\", p.name, p.level);\n\n    return 0;\n}\n",
  'struct-nested':
    "#include <stdio.h>\n\ntypedef struct {\n    int day;\n    int month;\n    int year;\n} Date;\n\ntypedef struct {\n    char name[32];\n    Date born;\n} Person;\n\nint main(void) {\n    Person p;\n\n    printf(\"Enter a name: \");\n    scanf(\"%31s\", p.name);\n\n    printf(\"Enter day month year: \");\n    scanf(\"%d %d %d\", &p.born.day, &p.born.month, &p.born.year);\n\n    printf(\"%s was born on %02d/%02d/%d\\n\", p.name, p.born.day, p.born.month, p.born.year);\n\n    return 0;\n}\n",
  'struct-sort':
    "#include <stdio.h>\n\ntypedef struct {\n    char name[32];\n    int level;\n} Pokemon;\n\nint main(void) {\n    Pokemon team[50], tmp;\n    int n, i, j;\n\n    printf(\"Enter how many: \");\n    scanf(\"%d\", &n);\n\n    printf(\"Enter a name and level for each: \");\n    for (i = 0; i < n; i++) {\n        scanf(\"%31s %d\", team[i].name, &team[i].level);\n    }\n\n    for (i = 0; i < n - 1; i++) {\n        for (j = 0; j < n - 1 - i; j++) {\n            if (team[j].level < team[j + 1].level) {\n                tmp = team[j];\n                team[j] = team[j + 1];\n                team[j + 1] = tmp;\n            }\n        }\n    }\n\n    for (i = 0; i < n; i++) {\n        printf(\"%s %d\\n\", team[i].name, team[i].level);\n    }\n\n    return 0;\n}\n",
  'struct-menu':
    "#include <stdio.h>\n\ntypedef struct {\n    int id;\n    char name[32];\n    int year;\n} Student;\n\nint main(void) {\n    Student list[50];\n    int count = 0, choice, i, id, found;\n\n    do {\n        printf(\"=== Student Records ===\\n\");\n        printf(\"1. Add a student\\n\");\n        printf(\"2. List all\\n\");\n        printf(\"3. Find by ID\\n\");\n        printf(\"0. Exit\\n\");\n        printf(\"Choice: \");\n        scanf(\"%d\", &choice);\n\n        switch (choice) {\n            case 1:\n                printf(\"Enter id name year: \");\n                scanf(\"%d %31s %d\", &list[count].id, list[count].name, &list[count].year);\n                printf(\"Added %s\\n\", list[count].name);\n                count = count + 1;\n                break;\n            case 2:\n                if (count == 0) {\n                    printf(\"No students yet\\n\");\n                } else {\n                    for (i = 0; i < count; i++) {\n                        printf(\"%d %s year %d\\n\", list[i].id, list[i].name, list[i].year);\n                    }\n                }\n                break;\n            case 3:\n                printf(\"Enter an id: \");\n                scanf(\"%d\", &id);\n                found = -1;\n                for (i = 0; i < count; i++) {\n                    if (list[i].id == id) {\n                        found = i;\n                    }\n                }\n                if (found == -1) {\n                    printf(\"Not found\\n\");\n                } else {\n                    printf(\"Found %s year %d\\n\", list[found].name, list[found].year);\n                }\n                break;\n            case 0:\n                break;\n            default:\n                printf(\"No such choice\\n\");\n                break;\n        }\n    } while (choice != 0);\n\n    printf(\"Bye\\n\");\n    return 0;\n}\n",
