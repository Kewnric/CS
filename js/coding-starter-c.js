...
function codingStarterFundamentals() {
  const nodes = [
    { id: 'starter-folder-4', type: 'folder', name: '4 · Arrays',              parentId: null, scope: 'challenge', order: 3 },
    { id: 'starter-folder-5', type: 'folder', name: '5 · Pointers',            parentId: null, scope: 'challenge', order: 4 },
    { id: 'starter-folder-6', type: 'folder', name: '6 · Memory you ask for',  parentId: null, scope: 'challenge', order: 5 },
    { id: 'starter-folder-7', type: 'folder', name: '7 · Structs and a bag',   parentId: null, scope: 'challenge', order: 6 }
  ];
