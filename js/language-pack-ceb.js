...
{ g: 'Numbers', tags: ['numbers', 'core'], pos: 'adjective', w: [
  ...
  ['tunga', 'half / middle', 'One half, and also the middle of something.', 'Tunga sa oras. / Tunga sa gabii.|Half an hour. / The middle of the night.', 'Doubled as "tunga-tunga" it means right in the centre.'],
...
{ g: 'More verbs', tags: ['verbs'], pos: 'verb', w: [
  ...
  ['hulog', 'fall / instalment', 'To fall or drop, and a single payment of many.', 'Nahulog ni. / Hulog-hulog lang ang bayad.|This fell. / Pay it in instalments.', 'The payment sense comes from dropping the money in, bit by bit.'],
...
{ g: 'Farming', tags: ['farming', 'nature', 'work'], w: [
  ...
  ['tubo', 'sugarcane / pipe / grow', 'Sugarcane, and quite separately a pipe or tube. Also to grow.', 'Uma sa tubo. / Guba ang tubo sa tubig.|A sugarcane field. / The water pipe is broken.', 'Three meanings, one spelling. Context separates them every time.'],
  ['abono', 'fertiliser / to advance money', 'Fertiliser. Also to pay for someone now and be repaid later.', 'Kinahanglan ug abono. / Abonohi sa ko.|It needs fertiliser. / Cover it for me for now.', 'Both senses are common; the money one more so in town.'],
...
{ g: 'Government and community', tags: ['civic', 'places'], pos: 'noun', w: [
  ...
  ['gobyerno', 'government', 'The government, at any level.', 'Ang gobyerno naghatag ug tabang.|The government gave aid.', ''],
  ['balaod', 'law', 'A law, or the law in general.', 'Supak na sa balaod.|That is against the law.', ''],
  ['pulis', 'police', 'A police officer, or the police.', 'Gitawag namo ang pulis.|We called the police.', ''],
  ['sundalo', 'soldier', 'A soldier.', 'Sundalo ang iyang amahan.|His father is a soldier.', ''],
  ['korte', 'court', 'A court of law.', 'Didto na sa korte ang kaso.|The case is in court now.', ''],
  ['huwes', 'judge', 'A judge.', 'Ang huwes wala pa miabot.|The judge has not arrived yet.', ''],
  ['abogado', 'lawyer', 'A lawyer.', 'Nangita siya ug abogado.|She looked for a lawyer.', ''],
  ['silot', 'punishment', 'A punishment or penalty.', 'Bug-at ang silot.|The punishment is heavy.', ''],
  ['buhis', 'tax', 'Tax.', 'Nagbayad ko sa akong buhis.|I paid my tax.', ''],
  ['sedula', 'community tax certificate', 'The small certificate you are asked for constantly as proof of residence.', 'Dad-a ang imong sedula.|Bring your cedula.', 'Ask for it by this name at the barangay hall; nobody says the official title.'],
  ['papeles', 'papers / documents', 'Documents of any official kind.', 'Kompleto ba ang papeles?|Are the documents complete?', ''],
  ['permiso', 'permit / permission', 'A permit, and also permission to do something.', 'Nangayo ko ug permiso.|I asked for permission.', 'Also used at a door: "permiso" as you step past someone.'],
  ['reklamo', 'complaint', 'A complaint.', 'Naay reklamo ang silingan.|The neighbour has a complaint.', ''],
  ['miting', 'meeting', 'A meeting.', 'Naay miting ugma.|There is a meeting tomorrow.', ''],
  ['konseho', 'council', 'A council, especially the barangay or city council.', 'Ang konseho nagdesisyon.|The council decided.', ''],
  ['piliay', 'election', 'An election.', 'Kanus-a ang piliay?|When is the election?', ''],
  ['botar', 'to vote', 'To vote.', 'Nagbotar ka ba?|Did you vote?', ''],
  ['lungsod', 'town', 'A town, or the town centre as opposed to the countryside.', 'Moadto mi sa lungsod.|We will go into town.', ''],
  ['siyudad', 'city', 'A city.', 'Nagpuyo siya sa siyudad.|He lives in the city.', ''],
  ['probinsya', 'province', 'A province, and by extension the provinces -- home, for most city workers.', 'Mopauli ko sa probinsya.|I am going home to the province.', ''],
]},

{ g: 'Sports and play', tags: ['leisure', 'sports'], w: [
  ['basketbol', 'basketball', 'Basketball, played on every barangay court in the country.', 'Magbasketbol ta unya.|Let us play basketball later.', ''],
  ['bola', 'ball', 'A ball.', 'Asa ang bola?|Where is the ball?', ''],
  ['daog', 'win', 'To win, or a win.', 'Daog mi!|We won!', ''],
  ['pildi', 'defeated / lost', 'To lose, or beaten.', 'Pildi mi sa una nga dula.|We lost the first game.', ''],
  ['koponan', 'team', 'A team.', 'Lig-on ang ilang koponan.|Their team is strong.', ''],
  ['kontra', 'opponent', 'An opponent, or against.', 'Kinsa ang atong kontra?|Who is our opponent?', ''],
  ['ensayo', 'practice / rehearsal', 'Training or rehearsing for a game or performance.', 'Naay ensayo karong hapon.|There is practice this afternoon.', ''],
  ['taguan', 'hide and seek', 'The children\'s game.', 'Magtaguan ta!|Let us play hide and seek!', 'From "tago", to hide.'],
  ['tumbang preso', 'tumbang preso', 'A street game of knocking over a tin can with a slipper.', 'Nagdula mi ug tumbang preso.|We played tumbang preso.', 'Needs a can, a slipper each and a road with no cars.'],
  ['patintero', 'patintero', 'A street game of crossing lines without being tagged.', 'Kusog siya modula ug patintero.|He is good at patintero.', ''],
  ['tabanog', 'kite', 'A kite.', 'Gipalupad namo ang tabanog.|We flew the kite.', ''],
  ['tsampyon', 'champion', 'The champion.', 'Tsampyon ang among eskwelahan.|Our school is the champion.', ''],
  ['premyo', 'prize', 'A prize or award.', 'Unsa ang premyo?|What is the prize?', ''],
  ['puntos', 'points / score', 'Points in a game.', 'Pila na ang puntos?|What is the score now?', ''],
  ['sugal', 'gambling', 'Gambling.', 'Ayaw ug sugal.|Do not gamble.', ''],
  ['baraha', 'playing cards', 'Playing cards.', 'Nagdula sila ug baraha.|They were playing cards.', ''],
  ['dama', 'checkers', 'The board game, played everywhere on hand-drawn boards.', 'Magdama ta.|Let us play checkers.', ''],
  ['bulang', 'cockfighting', 'Cockfighting, a serious Sunday institution.', 'Adto siya sa bulangan.|He went to the cockpit.', 'The arena is the "bulangan". An informal roadside match is a "tupada".'],
  ['lumba', 'race', 'A race or contest.', 'Naay lumba sa dagan.|There is a running race.', ''],
  ['ligo sa dagat', 'swim at the beach', 'Going to the sea to swim -- the default weekend outing.', 'Moligo mi sa dagat ugma.|We will swim at the beach tomorrow.', '"Ligo" is to bathe; at the sea it simply means a swim.'],
]},

{ g: 'Music and the arts', tags: ['arts', 'culture'], w: [
  ['tugtog', 'to play music', 'To play an instrument, or music playing.', 'Nagtugtog siya ug gitara.|He is playing the guitar.', ''],
  ['gitara', 'guitar', 'The guitar -- the instrument of Cebuano social life.', 'Naa koy gitara sa balay.|I have a guitar at home.', ''],
  ['tambol', 'drum', 'A drum.', 'Kusog ang tambol.|The drum is loud.', ''],
  ['harana', 'serenade', 'Singing outside the window of someone you are courting.', 'Giharana niya ang iyang gimahal.|He serenaded the one he loved.', 'Old-fashioned now, but everyone knows the word and the picture it makes.'],
  ['balak', 'poem', 'A poem, or poetry.', 'Nagsulat siya ug balak.|She wrote a poem.', ''],
  ['sugilanon', 'story', 'A story or tale.', 'Isugilon ang sugilanon.|Tell the story.', ''],
  ['hulagway', 'picture / image', 'A picture, an image, and by extension a photograph.', 'Nindot ang hulagway.|The picture is beautiful.', ''],
  ['dibuho', 'drawing', 'A drawing.', 'Maayo siya mo-dibuho.|He draws well.', ''],
  ['pintal', 'to paint', 'To paint, both pictures and walls.', 'Gipintalan namo ang bungbong.|We painted the wall.', ''],
  ['litrato', 'photograph', 'A photograph.', 'Pakuhaa ko ug litrato.|Take a photo of me.', ''],
  ['sine', 'movie', 'A film, and the cinema.', 'Manan-aw ta ug sine.|Let us watch a movie.', ''],
  ['artista', 'actor / actress', 'A screen actor, and loosely any celebrity.', 'Artista siya kaniadto.|She used to be an actress.', ''],
  ['mananayaw', 'dancer', 'A dancer.', 'Mananayaw siya sa Sinulog.|She is a Sinulog dancer.', ''],
  ['kuradang', 'kuradang', 'A lively traditional Visayan folk dance.', 'Gisayaw nila ang kuradang.|They danced the kuradang.', ''],
  ['Sinulog', 'Sinulog', 'Cebu\'s January festival honouring the Santo Nino, and its two-step dance.', 'Puno ang siyudad panahon sa Sinulog.|The city is full during Sinulog.', 'The step is forward-forward-back, in time with the drums -- "sulog" is the river current it imitates.'],
  ['bayle', 'a dance / party', 'A community dance, especially during fiesta.', 'Naay bayle karong gabii.|There is a dance tonight.', ''],
  ['koro', 'choir', 'A choir.', 'Miyembro siya sa koro.|She is a member of the choir.', ''],
  ['banda', 'band', 'A band, musical or marching.', 'Nag-agi ang banda.|The band passed by.', ''],
]},

{ g: 'Order, halves and money', tags: ['numbers', 'money'], w: [
  ['ikatulo', 'third', 'Third in order.', 'Ikatulo ko nga anak.|I am the third child.', ''],
  ['ikaupat', 'fourth', 'Fourth in order.', 'Ikaupat nga adlaw na ni.|This is the fourth day.', ''],
  ['ikalima', 'fifth', 'Fifth in order.', 'Ikalima siya nga miabot.|He arrived fifth.', ''],
  ['bahin', 'part / share', 'A part, portion or share.', 'Kini ang imong bahin.|This is your share.', ''],
  ['doble', 'double', 'Twice as much.', 'Doble ang presyo karon.|The price is double now.', ''],
  ['sentimo', 'centavo', 'A centavo, a hundredth of a peso.', 'Wala na koy sentimo.|I have not a centavo left.', ''],
  ['singko', 'five', 'Five, used mostly of money and prices.', 'Singko ra ang tubig.|The water is only five.', 'Spanish numbers are used for money and time; the Cebuano ones for counting things.'],
  ['diyes', 'ten', 'Ten, of money.', 'Diyes pesos ang plete.|The fare is ten pesos.', ''],
  ['bente', 'twenty', 'Twenty, of money.', 'Bente ra ni.|This is only twenty.', ''],
  ['tag-pila', 'how much each', 'Asking the price per item.', 'Tag-pila ang mangga?|How much is each mango?', 'Different from "pila", how much in total.'],
  ['porsyento', 'percent', 'Percent.', 'Napulo ka porsyento ang diskwento.|The discount is ten percent.', ''],
  ['ubos', 'low / cheap', 'Low, and of a price, cheap.', 'Ubos ang presyo karon.|The price is low now.', 'Also low in position: "ubos nga lamesa", a low table.'],
  ['tinuod nga presyo', 'the real price', 'The actual price, as opposed to the one quoted to a stranger.', 'Unsa man ang tinuod nga presyo?|What is the real price?', 'Worth knowing. Asking in Cebuano usually gets you it.'],
  ['ginansya', 'profit', 'The profit on something sold.', 'Gamay ra ang ginansya.|The profit is small.', ''],
  ['lugi', 'a loss', 'To lose money on a deal.', 'Lugi mi niadtong tuiga.|We lost money that year.', ''],
  ['puhunan', 'capital', 'The money you start a business with.', 'Wala koy puhunan.|I have no capital.', ''],
  ['pautang', 'to lend / sell on credit', 'To let someone take goods or money now and pay later.', 'Pautanga ko ug bugas.|Let me take rice on credit.', 'The whole sari-sari store economy runs on this.'],
  ['daginot', 'thrift', 'Careful economising; to make something last.', 'Daginoton nato ang tubig.|Let us use the water sparingly.', 'A virtue, unlike "kuripot", which is stingy.'],
  ['bayranan', 'bills to pay', 'The things owed -- rent, electricity, water.', 'Daghan kog bayranan.|I have a lot of bills.', ''],
...
{ g: 'Idioms', tags: ['idioms', 'phrases'], pos: 'phrase', w: [
  ...
  ['gahi ug ulo', 'stubborn', 'Hard of head.', 'Gahi kaayo ka ug ulo.|You are so stubborn.', ''],
  ['dako ug ulo', 'arrogant', 'Big of head -- full of oneself.', 'Dako na siya ug ulo.|He has gotten arrogant.', ''],
  ['hait ug dila', 'sharp-tongued', 'Sharp of tongue -- says cutting things.', 'Hait siya ug dila apan buotan.|She is sharp-tongued but kind.', ''],
  ['tam-is ug baba', 'sweet-talking', 'Sweet of mouth; flatters easily.', 'Tam-is siya ug baba sa mga kustomer.|He sweet-talks the customers.', ''],
  ['luag ug kamot', 'generous', 'Loose of hand -- free with money and help.', 'Luag siya ug kamot sa iyang mga higala.|He is generous with his friends.', ''],
  ['gaan ug kamot', 'quick to hit', 'Light of hand; strikes before thinking.', 'Ayaw pagpakig-away, gaan siya ug kamot.|Do not fight him, he hits fast.', 'Note how the same "gaan" is a compliment with dugo and a warning with kamot.'],
  ['baga ug nawong', 'shameless', 'Thick of face; has no shame.', 'Baga kaayo siya ug nawong.|He has no shame at all.', ''],
  ['nipis ug panit', 'thin-skinned', 'Thin of skin; easily hurt.', 'Nipis siya ug panit, ayaw biay-biaya.|She is thin-skinned, do not tease her.', ''],
  ['taas ug pasensya', 'patient', 'Long of patience.', 'Taas siya ug pasensya sa mga bata.|She is patient with children.', ''],
  ['mubo ug pasensya', 'impatient', 'Short of patience.', 'Mubo ko ug pasensya sa trapik.|I have no patience for traffic.', ''],
  ['wala\'y buot', 'without sense', 'Lacking judgement; of a small child, simply too young to know.', 'Bata pa, wala pa\'y buot.|He is still a child, he does not know any better.', ''],
  ['naa\'y buot', 'sensible', 'Has good sense; grown up enough to know better.', 'Naa na siya\'y buot.|He has sense now.', ''],
  ['pait ang kinabuhi', 'life is hard', 'Literally life is bitter -- said wryly, often while laughing.', 'Pait ang kinabuhi, bai.|Life is bitter, mate.', '"Pait" alone has become slang for anything unfortunate.'],
  ['kusog ug kaon', 'a big eater', 'Eats a lot -- usually said approvingly.', 'Kusog siya ug kaon, maayo na.|He eats well, that is good.', ''],
  ['wala\'y hinungdan', 'pointless', 'Without cause or reason; a waste of time.', 'Wala\'y hinungdan ang atong gilalisan.|What we argued about was pointless.', ''],
  ['hinay-hinay lang', 'take it easy', 'Slowly, gently -- both advice and consolation.', 'Hinay-hinay lang, dili ta magdali.|Take it easy, we are not in a hurry.', ''],
  ['kuyaw', 'intense / scary', 'Frightening, and by slang extension impressive.', 'Kuyaw kaayo ang bagyo. / Kuyaw ka!|The storm was terrifying. / You are amazing!', 'Like English "wicked": the meaning flips entirely with tone.'],
...
{ g: 'Joining words', tags: ['grammar', 'core'], pos: 'conjunction', w: [
  ...
  ['sa dili pa', 'before', 'Before something happens.', 'Sa dili pa ka mogawas, panghipos.|Before you go out, tidy up.', ''],
  ['samtang', 'while', 'While, during the time that.', 'Samtang nagluto siya, naglimpyo ko.|While she cooked, I cleaned.', ''],
  ['tungod kay', 'because of', 'Because of -- a fuller form of "kay".', 'Tungod kay hinay ang internet.|Because the internet is slow.', ''],
  ['labi na', 'especially', 'Especially; above all.', 'Init kaayo, labi na sa udto.|It is very hot, especially at noon.', ''],
  ['gawas kung', 'unless', 'Unless.', 'Moadto ko, gawas kung mo-ulan.|I will go, unless it rains.', ''],
  ['sa katapusan', 'in the end', 'Finally, at the end.', 'Sa katapusan, nagkasabot sila.|In the end, they came to an agreement.', ''],
...
{ g: 'Church and fiesta', tags: ['culture', 'belief'], pos: 'noun', w: [
  ...
  ['santo', 'saint', 'A saint, and a saint\'s image.', 'Gidala nila ang santo.|They carried the saint.', 'The Santo Nino -- the Holy Child -- is Cebu\'s own.'],
  ['kandila', 'candle', 'A candle, especially one lit at church.', 'Nagdagkot siya ug kandila.|She lit a candle.', ''],
  ['Pasko', 'Christmas', 'Christmas.', 'Malipayong Pasko!|Merry Christmas!', 'The season starts in September. This is not a joke.'],
  ['fiesta', 'town feast', 'The annual feast of a town\'s patron saint: food, a dance and open houses.', 'Fiesta sa among lungsod ugma.|It is our town fiesta tomorrow.', 'On fiesta day you may walk into almost any house and be fed.'],
  ['patron', 'patron saint', 'The patron saint of a place.', 'Si San Pedro ang among patron.|Saint Peter is our patron.', ''],
  ['bunyag', 'baptism', 'A baptism, and to baptise.', 'Ugma ang bunyag sa bata.|The child\'s baptism is tomorrow.', ''],
  ['kalag', 'soul', 'The soul or spirit.', 'Ang mga kalag sa atong mga minahal.|The souls of our loved ones.', '"Kalag-kalag" is the All Souls\' Day visit to the cemetery.'],
  ['panaad', 'a vow', 'A promise made to a saint, repaid by dancing or walking a procession.', 'Gituman niya ang iyang panaad.|She fulfilled her vow.', ''],
  ['rosaryo', 'rosary', 'The rosary.', 'Nag-rosaryo ang pamilya.|The family prayed the rosary.', ''],
  ['krus', 'cross', 'A cross.', 'Nagkrus siya sa iyang kaugalingon.|She crossed herself.', ''],
  ['bendisyon', 'blessing', 'A blessing.', 'Nangayo mi ug bendisyon.|We asked for a blessing.', 'Children take an elder\'s hand to their forehead for this; the gesture is "pagmano".'],
  ['impyerno', 'hell', 'Hell.', 'Kahadlok sa impyerno.|Fear of hell.', ''],
  ['anghel', 'angel', 'An angel.', 'Anghel ang nagbantay nimo.|An angel watches over you.', ''],
  ['prusisyon', 'procession', 'A religious procession through the streets.', 'Taas ang prusisyon.|The procession is long.', ''],
  ['nobena', 'novena', 'Nine days of prayer, usually before a fiesta.', 'Nagsugod na ang nobena.|The novena has started.', ''],
  ['Santo Nino', 'the Holy Child', 'The image of the child Jesus -- Cebu\'s patron and its oldest relic.', 'Gidala nila ang Santo Nino.|They carried the Santo Nino.', 'Pit Senyor is what the crowd shouts to him during Sinulog.'],
  ['pagmano', 'the blessing gesture', 'Taking an elder\'s hand to your forehead as a greeting.', 'Mano ka sa imong lolo.|Take your grandfather\'s hand.', 'Doing this unprompted the first time you meet a family is worth a hundred words of vocabulary.'],
]},

{ g: 'Directions and position', tags: ['places', 'core'], w: [
  ['amihanan', 'north', 'North.', 'Sa amihanan sa siyudad.|To the north of the city.', 'From "amihan", the cool north wind of the dry season.'],
  ['habagatan', 'south', 'South.', 'Gikan mi sa habagatan.|We came from the south.', 'From "habagat", the wet monsoon wind.'],
  ['sidlakan', 'east', 'East.', 'Sa sidlakan mosubang ang adlaw.|The sun rises in the east.', ''],
  ['kasadpan', 'west', 'West.', 'Padulong sa kasadpan.|Heading west.', ''],
  ['kilid', 'side', 'The side of something.', 'Sa kilid sa dalan.|At the side of the road.', ''],
  ['tupad', 'next to', 'Beside, next to.', 'Lingkod sa akong tupad.|Sit next to me.', ''],
  ['suok', 'corner', 'A corner.', 'Sa suok sa kwarto.|In the corner of the room.', ''],
  ['lugar lang', 'stop here please', 'What you call out to get off a jeepney.', 'Lugar lang, manong!|Stop here please, sir!', 'The single most practical phrase for getting around Cebu.'],
...
{ g: 'Tools and materials', tags: ['objects', 'work'], pos: 'noun', w: [
  ...
  ['sundang', 'bolo', 'The long working knife carried everywhere in the countryside.', 'Dala siya ug sundang.|He is carrying a bolo.', 'A farm tool first, and the reason nobody needs an axe.'],
  ['sanggot', 'sickle', 'A sickle, for cutting grass and grain.', 'Gigamit niya ang sanggot.|He used the sickle.', ''],
  ['puthaw', 'iron / metal', 'Iron or metal.', 'Puthaw ang ganghaan.|The gate is iron.', ''],
  ['plastik', 'plastic', 'Plastic.', 'Butangi ug plastik.|Put it in a plastic bag.', ''],
  ['pisi', 'rope', 'Rope or string.', 'Higti ug pisi.|Tie it with rope.', ''],
  ['baldi', 'bucket', 'A bucket.', 'Puno na ang baldi.|The bucket is full.', ''],
  ['semento', 'cement', 'Cement.', 'Nagpalit mi ug semento.|We bought cement.', ''],
  ['abo', 'ash', 'Ash.', 'Puno sa abo ang kalayo.|The fire is full of ash.', ''],
  ['tornilyo', 'screw', 'A screw.', 'Higti ang tornilyo.|Tighten the screw.', ''],
...
{ g: 'Hedging and hearsay', tags: ['particles', 'grammar'], pos: 'particle', w: [
  ...
  ['morag', 'seems like / sort of', 'It looks as though; resembling.', 'Morag mo-ulan.|It looks like rain.', 'Often shortened to "murag". Used constantly to soften a statement.'],
  ['kaha', 'I wonder', 'Turns a question inward -- wondering rather than asking.', 'Asa kaha siya?|Where could he be, I wonder?', ''],
  ['hinuon', 'actually / on the contrary', 'Corrects or qualifies what was just said.', 'Maayo hinuon na.|That is actually a good thing.', ''],
...
{ g: 'Around the neighbourhood', tags: ['places', 'home'], pos: 'noun', w: [
  ...
  ['kanto', 'junction', 'A corner or junction, often where you catch a ride.', 'Sakay sa kanto.|Get on at the junction.', ''],
  ['agianan', 'passage / way through', 'A path, alley or way through.', 'Sirado ang agianan.|The passage is closed.', ''],
  ['atbang', 'across from', 'Opposite, facing.', 'Atbang sa tindahan.|Across from the shop.', ''],
  ['libot', 'around', 'Around, and to go around.', 'Naglibot mi sa lungsod.|We went around the town.', ''],
  ['sikbit', 'right next door', 'Immediately adjacent.', 'Sikbit ra mi.|We are right next door to each other.', ''],
  ['tulay', 'bridge', 'A bridge.', 'Tabok sa tulay.|Cross the bridge.', ''],
  ['kanal', 'ditch / drain', 'A drainage ditch or canal.', 'Puno ang kanal.|The drain is full.', ''],
  ['poso', 'water pump / well', 'The communal hand pump or well.', 'Nagsag-ob mi sa poso.|We fetched water at the pump.', ''],
  ['ganghaan', 'gate', 'A gate.', 'Abli ang ganghaan.|The gate is open.', ''],
  ['koral', 'fence', 'A fence or enclosure.', 'Gikoralan nila ang uma.|They fenced the field.', ''],
  ['kapilya', 'chapel', 'The small chapel a purok keeps, as distinct from the town church.', 'Naay misa sa kapilya.|There is a mass at the chapel.', ''],
]},
...
function _langCebWord(r) {
  ...
  rec.forms.ceb = {
    ...
    examples: r.example && r.example.indexOf('|') > -1
      ...
      : [],
    /* A usage note is an aside, not a caution: it belongs in notes.
       restrictions is what the UI paints amber with a warning triangle. */
    notes: r.note || '',
    restrictions: ''
  };
