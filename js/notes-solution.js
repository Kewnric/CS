...
function initNotesSolution() {
  loadData();
  const nsRoot = document.getElementById('notes-solution-view') || document.getElementById('main-content');
  lucide.createIcons(nsRoot ? { root: nsRoot } : undefined);
...
function renderResults(record) {
  ...
  const sectionsEl = document.getElementById('ns-sections-review');
  sectionsEl.innerHTML = sectionsHtml;
  lucide.createIcons({ root: sectionsEl });
}
