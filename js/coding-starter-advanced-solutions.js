...
const CS_ADV_SOLUTIONS = {
  'str-menu':
    "#include <stdio.h>\n#include <string.h>\n\nint main(void) {\n    char words[50][32];\n    char needle[32], tmp[32];\n    int count = 0, choice, i, found;\n\n    do {\n        printf(\"=== Word List ===\\n\");\n        printf(\"1. Add a word\\n\");\n        printf(\"2. List\\n\");\n        printf(\"3. Search\\n\");\n        printf(\"4. Longest\\n\");\n        printf(\"0. Exit\\n\");\n        printf(\"Choice: \");\n        scanf(\"%d\", &choice);\n\n        switch (choice) {\n            case 1:\n                printf(\"Enter a word: \");\n                scanf(\"%31s\", words[count]);\n                printf(\"Added %s (%d letters)\\n\", words[count], (int) strlen(words[count]));\n                count = count + 1;\n                break;\n            case 2:\n                if (count == 0) {\n                    printf(\"No words yet\\n\");\n                } else {\n                    for (i = 0; i < count; i++) {\n                        printf(\"%d. %s\\n\", i + 1, words[i]);\n                    }\n                }\n                break;\n            case 3:\n                printf(\"Enter a word: \");\n                scanf(\"%31s\", needle);\n                found = -1;\n                for (i = 0; i < count; i++) {\n                    if (strcmp(words[i], needle) == 0) {\n                        found = i;\n                    }\n                }\n                if (found == -1) {\n                    printf(\"Not in the list\\n\");\n                } else {\n                    printf(\"Found at %d\\n\", found + 1);\n                }\n                break;\n            case 4:\n                if (count == 0) {\n                    printf(\"No words yet\\n\");\n                } else {\n                    strcpy(tmp, words[0]);\n                    for (i = 1; i < count; i++) {\n                        if (strlen(words[i]) > strlen(tmp)) {\n                            strcpy(tmp, words[i]);\n                        }\n                    }\n                    printf(\"Longest is %s\\n\", tmp);\n                }\n                break;\n            case 0:\n                break;\n            default:\n                printf(\"No such choice\\n\");\n                break;\n        }\n    } while (choice != 0);\n\n    printf(\"Bye\\n\");\n    return 0;\n}\n",
  /* ── Added variations ────────────────────────────────────
